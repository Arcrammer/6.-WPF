...
function howLongWillItTakeToUploadTheFiles(speed,size,patience) {
	...
	if(patience === true) {
		var output = console.log("It will take " + howLongItWillTakeToUpload + " minutes to upload the files. Because you're patient, you'll have no problem waiting through this time for the files to upload!");
	} else if(patience === false) {
		var output = console.log("It will take " + howLongItWillTakeToUpload + " minutes to upload the files. Because you're nbot patient, you'll have some issues waiting through this time for the files to upload, so I suggest you take a minute to relax and chill out!");
